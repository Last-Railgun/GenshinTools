 ...
 * ReactionRate
 * 用于存放反应的反应基础倍率<br/>
 * 增幅反应仅存在克制和被克制,如水触发火蒸发 2.0, 冰触发火融化 1.5<br/>
 * 超导 0.5 : 扩散 0.6 : 碎冰 1.5 : 超载 2 : 感电 1.2 : 绽放 2 : 烈绽放 3 : 超绽放 3 : 燃烧 0.25<br/>
 * 超激化 1.15, 蔓激化 1.25<br/>
...
public enum ReactionRate {
    ...
    AGGRAVATE("超激化", 1.15),     // 超激化基础倍率
    SPREAD("蔓激化", 1.25),        // 蔓激化基础倍率
    BLOOM("绽放", 2.0),           // 绽放基础倍率
